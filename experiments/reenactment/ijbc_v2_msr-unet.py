...
from fsgan.train_reenactment import main
...
if __name__ == '__main__':
    ...
    optimizer = partial(optim.Adam, lr=2e-5, betas=(0.5, 0.999))
    ...
    main(exp_dir, train_dir, val_dir, train_dataset=train_dataset, val_dataset=val_dataset,
         ...
         generator=generator, discriminator=discriminator, criterion_id=criterion_id, criterion_gan=criterion_gan,
         optimizer=optimizer, scheduler=scheduler, seg_model=seg_model, seg_weight=seg_weight, start_epoch=start_epoch)
