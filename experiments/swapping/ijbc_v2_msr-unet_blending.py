...
if __name__ == '__main__':
    ...
    train_dataset = partial(SegmentationLandmarksPairDataset, img_list='seg_splits/img_list_train.txt',
                            ...
                            seg_list='seg_splits/seg_list_train.txt', same_prob=0)
    val_dataset = partial(SegmentationLandmarksPairDataset, img_list='seg_splits/img_list_val.txt',
                          ...
                          seg_list='seg_splits/seg_list_val.txt', same_prob=0)
    ...
    gen_blender = res_unet.MultiScaleResUNet(in_nc=7, out_nc=3, flat_layers=(1, 0, 1, 1), ngf=128)
    ...
    main(exp_dir, train_dir, val_dir, train_dataset=train_dataset, val_dataset=val_dataset,
         ...
         gen_blender=gen_blender, discriminator=discriminator, criterion_id=criterion_id, criterion_gan=criterion_gan,
         optimizer=optimizer, scheduler=scheduler, gan_weight=gan_weight, resume_dir=resume_dir,
